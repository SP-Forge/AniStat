        ...
        <div className="bg-cover bg-[url('/red%20and%20black.png')] min-h-screen">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="flex flex-wrap justify-center gap-6 w-full">
                    <Link href="/game" className="w-62 rounded-xl border border-red1/60 bg-black1/85 shadow-lg overflow-hidden hover:scale-105 transition-transform">
                    ...
                    <Link href="/game2" className="w-62 rounded-xl border border-red1/60 bg-black1/85 shadow-lg overflow-hidden hover:scale-105 transition-transform">
                    ...
                    <Link href="/game3" className="w-62 rounded-xl border border-red1/60 bg-black1/85 shadow-lg overflow-hidden hover:scale-105 transition-transform">
             ...
             <div className="max-w-7xl mx-auto border-red1 border-4 bg-black2/70  flex justify-center items-center flex-col rounded-lg shadow-lg p-8 mb-12">
                ...
                <div className="flex flex-wrap justify-center gap-6 w-full">
                    <Link href="/pokemon1" className="w-62 rounded-xl border border-red1/60 bg-black1/85 shadow-lg overflow-hidden hover:scale-105 transition-transform">
                    ...
                    <Link href="/pokemon2" className="w-62 rounded-xl border border-red1/60 bg-black1/85 shadow-lg overflow-hidden hover:scale-105 transition-transform">
                    ...
                    <Link href="/pokemon3" className="w-62 rounded-xl border border-red1/60 bg-black1/85 shadow-lg overflow-hidden hover:scale-105 transition-transform">
