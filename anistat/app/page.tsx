        ...
        <div className="bg-cover bg-[url('/red%20and%20black.png')] min-h-screen">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="max-w-7xl mx-auto border-red1 border-4 bg-black2/70  flex justify-center items-center flex-col rounded-lg shadow-lg p-8 mb-12">
                    ...
                    <div className="flex justify-center mt-8 flex flex-wrap justify-center gap-6 w-full">
                        ...
                        <Link href="/TicTacChu" className="w-62 rounded-xl border border-red1/60 bg-black1/85 shadow-lg overflow-hidden hover:scale-105 transition-transform flex flex-col items-center">
                            <img className="w-full h-80 object-cover" src="/tictachu.png" alt="Tic Tac Chu" />
                            <div className="px-3 py-2 text-center text-xl font-bold text-white/90">Tic Tac Chu</div>
                        </Link>
                    </div>
